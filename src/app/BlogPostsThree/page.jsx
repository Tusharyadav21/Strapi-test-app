...
const BlogPostsSevenPage = () => {
  return (
    <>
      <div className="  flex flex-col font-montserrat items-center justify-start mx-auto p-[48px] md:px-10 sm:px-5 w-full">
        <div className="flex flex-col gap-[52px] justify-start max-w-[1141px] mx-auto pt-[9px] w-full">
